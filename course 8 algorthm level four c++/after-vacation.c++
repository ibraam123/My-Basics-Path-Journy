...
short fVacationDays() {
    short vacationdays;
    cout << "plese enter vacation days? " << endl;
    cin >> vacationdays;

    return vacationdays;
}

stDate dateafter_vacation(stDate date){

    short vacationdays = fVacationDays();
...
int main() {
    ...
    DateFrom = dateafter_vacation(DateFrom);

    
    cout << "\n returned date:  " << DayShortName(DayOfWeekOrder(DateFrom)) << " , "
