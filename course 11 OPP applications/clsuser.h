...
protected:
   ...
   enum enMode { EmptyMode = 0, UpdateMode = 1, AddNewMode = 2 };
    ...
    bool _MarkedForDelete = false;
     ...
     struct stLoginRegisterRecord // Move struct definition here
    {
        string DateTime;
        string UserName;
        string Password;
    ...
    static string _ConverUserObjectToLine(clsUser User, string Seperator = "#//#")
    {
        ...
        UserRecord += (User.GetPermissions());
...
public:
    ...
    enum enPermissions {
        ...
        , pRegigsterlogin = 128 , pCurrncyExchange = 256
    };
    ...
    {
        if (stoi(this->GetPermissions()) == enPermissions::eAll)
            return true;

        if ((Permission & stoi(this->GetPermissions())) == Permission)
            return true;
        else
            return false;
